...
1. Frida [DumpMetadata.js](https://github.com/violet-wdream/.Scripts/blob/main/Frida/DumpMetadata.js)

2. libil2cpp.so中搜索字符串`global-metadata.dat`，寻找相关处理方法

3. [hybridclr](https://github.com/focus-creative-games/hybridclr)

   [代码加固 | HybridCLR](https://www.hybridclr.cn/docs/7.8.1/business/basicencryption)

4. [How Games Counter IL2CppDumper Reverse Engineering](https://www.jikguard.com/blog/how-games-counter-il2cppdumper-reverse-engineering/)

5. [Zygisk-IL2CppDumper Detection Solution](https://www.jikguard.com/blog/zygisk-il2cppdumper-detection-solution/)
