...
metadata加密，且动态dump失败

通过llm分析dll，定位到`sub_1801C1B80`，处理非常复杂。

`sub_18016DDC0`这里面有个`YQSY`很有意思

![image-20260613143233746](https://cdn.jsdelivr.net/gh/violet-wdream/Drawio/PNG/202606131432852.png)
